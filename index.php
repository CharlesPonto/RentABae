...
<head>
    ...
    <meta name="description" content="RentABae offers a safe and fun way to rent a charming boyfriend for events, dates, and companionship.">
...
<body class="bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 text-gray-900">
    ...
    <header class="bg-white shadow sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex items-center justify-between py-4 px-6">
            ...
            <a href="#book" class="ml-4 px-5 py-2 bg-pink-600 text-white rounded-full font-semibold shadow hover:bg-pink-700 transition hidden md:inline-block">Get Started</a>
            <!-- Hamburger (Mobile) -->
            <button id="nav-toggle" class="md:hidden ml-2 p-2 rounded focus:outline-none focus:ring-2 focus:ring-pink-400" aria-label="Open menu">
        ...
        <!-- Mobile Nav -->
        <div id="mobile-nav" class="md:hidden fixed inset-0 bg-white bg-opacity-95 z-50 flex flex-col items-center justify-center space-y-8 text-xl font-semibold text-pink-700 hidden">
            <button id="nav-close" class="absolute top-6 right-6 p-2 rounded focus:outline-none focus:ring-2 focus:ring-pink-400" aria-label="Close menu">
            ...
            <nav aria-label="Mobile navigation">
                <ul class="flex flex-col items-center space-y-6">
                    ...
                    <li><a href="#testimonials" class="hover:text-blue-600" onclick="closeMobileNav()">Testimonials</a></li>
                    <li><a href="#book" class="hover:text-blue-600" onclick="closeMobileNav()">Contact</a></li>
                    <li><a href="#book" class="px-6 py-2 bg-pink-600 text-white rounded-full shadow hover:bg-pink-700 transition">Get Started</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <main id="main-content">
        <!-- Hero Section -->
        <section class="relative bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 min-h-[70vh] flex flex-col items-center justify-center overflow-hidden">
            <div class="absolute inset-0 flex justify-center items-center pointer-events-none">
                <div class="w-96 h-96 bg-pink-200 rounded-full opacity-20 blur-3xl absolute -top-24 -left-24"></div>
                <div class="w-80 h-80 bg-purple-200 rounded-full opacity-20 blur-3xl absolute -bottom-24 -right-24"></div>
            </div>
            <div class="relative z-10 text-center max-w-2xl mx-auto p-8">
                <h1 class="text-4xl md:text-5xl font-extrabold mb-4 text-pink-700">Find Your Perfect Companion for Any Occasion</h1>
                <p class="text-lg md:text-xl mb-8 text-gray-800">Rent a charming, respectful, and friendly boyfriend—perfect for parties, events, or just a relaxing day out. Your trusted boyfriend rental service.</p>
                <div class="flex flex-col md:flex-row justify-center gap-4 mb-8">
                    <a href="#book" class="inline-block px-8 py-3 bg-pink-600 text-white rounded-full font-semibold shadow hover:bg-pink-700 transition">Get Started Now</a>
                    <a href="#boyfriends" class="inline-block px-8 py-3 bg-white text-pink-600 border border-pink-400 rounded-full font-semibold shadow hover:bg-pink-50 transition">Browse Boyfriends</a>
                </div>
                <!-- Collage of boyfriend images -->
                <div class="flex justify-center gap-4 mt-6">
                    <img src="assets/boyfriend_profiles/nyco.png" alt="Profile picture of Nyco" class="w-20 h-20 rounded-full object-cover border-4 border-pink-200 shadow-lg">
                    <img src="assets/boyfriend_profiles/adam.png" alt="Profile picture of Adam" class="w-20 h-20 rounded-full object-cover border-4 border-purple-200 shadow-lg">
                    <img src="assets/boyfriend_profiles/noe.png" alt="Profile picture of Noe" class="w-20 h-20 rounded-full object-cover border-4 border-blue-200 shadow-lg">
                    <img src="assets/boyfriend_profiles/charles.jpg" alt="Profile picture of Charles" class="w-20 h-20 rounded-full object-cover border-4 border-pink-200 shadow-lg">
                </div>
            </div>
        </section>
        ...
        <section class="py-16 bg-white" id="why">
            <div class="max-w-6xl mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-xl mx-auto">We know what girls want! Our service is designed for your comfort, fun, and safety. Here's why you'll love us:</p>
                </div>
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-pink-50 rounded-2xl p-8 shadow text-center">
                        <span class="inline-block bg-pink-200 p-3 rounded-full mb-4"><svg class="w-8 h-8 text-pink-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div class="bg-purple-50 rounded-2xl p-8 shadow text-center">
                        <span class="inline-block bg-purple-200 p-3 rounded-full mb-4"><svg class="w-8 h-8 text-purple-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M12 11c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm0 0V7m0 4v4m0 0c-4.418 0-8 1.79-8 4v2h16v-2c0-2.21-3.582-4-8-4z" />
                            </svg></span>
                    ...
                    <div class="bg-blue-50 rounded-2xl p-8 shadow text-center">
                        <span class="inline-block bg-blue-200 p-3 rounded-full mb-4"><svg class="w-8 h-8 text-blue-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M12 8c-1.657 0-3 1.343-3 3 0 1.657 1.343 3 3 3s3-1.343 3-3c0-1.657-1.343-3-3-3zm0 0V4m0 7v7m0 0c-4.418 0-8 1.79-8 4v2h16v-2c0-2.21-3.582-4-8-4z" />
                            </svg></span>
                        ...
                        <div id="boyfriend-carousel" class="flex transition-transform duration-500 ease-in-out">
                            ...
                            <div class="min-w-full sm:min-w-1/2 lg:min-w-1/3 px-4">
                                <div class="bg-blue-50 rounded-2xl shadow-lg p-6 flex flex-col items-center">
                                    <img src="assets/boyfriend_profiles/charles.jpg" alt="Image of Charles, Fullstack Developer" class="w-48 h-48 rounded-xl object-cover mb-4">
                            ...
                            <div class="min-w-full sm:min-w-1/2 lg:min-w-1/3 px-4">
                                <div class="bg-pink-50 rounded-2xl shadow-lg p-6 flex flex-col items-center">
                                    <img src="assets/boyfriend_profiles/nyco.png" alt="Image of Nyco, Technician" class="w-48 h-48 rounded-xl object-cover mb-4">
                            ...
                            <div class="min-w-full sm:min-w-1/2 lg:min-w-1/3 px-4">
                                <div class="bg-blue-50 rounded-2xl shadow-lg p-6 flex flex-col items-center">
                                    <img src="assets/boyfriend_profiles/noe.png" alt="Image of Noe, Frontend Developer" class="w-48 h-48 rounded-xl object-cover mb-4">
            ...
            <div class="max-w-4xl mx-auto px-4">
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    <div class="bg-pink-50 rounded-2xl p-6 shadow flex items-center gap-4">
                        <img src="assets/testimonial_profiles/julia-baretto.jpg" alt="Image of Julia Baretto, happy client, pop star" class="w-16 h-16 rounded-full object-cover border-4 border-pink-200">
                        <div>
                    ...
                    <div class="bg-blue-50 rounded-2xl p-6 shadow flex items-center gap-4">
                        <img src="assets/testimonial_profiles/liza-soberano.jpg" alt="Image of Liza Soberano, happy client, singer-songwriter" class="w-16 h-16 rounded-full object-cover border-4 border-blue-200">
                        <div>
                    ...
                    <div class="bg-purple-50 rounded-2xl p-6 shadow flex items-center gap-4">
                        <img src="assets/testimonial_profiles/kathryn-bernando.jpg" alt="Image of Kathryn Bernardo, happy client, actress" class="w-16 h-16 rounded-full object-cover border-4 border-purple-200">
                        <div>
                    ...
                    <div class="bg-pink-50 rounded-2xl p-6 shadow flex items-center gap-4">
                        <img src="assets/testimonial_profiles/main-mendoza.jpg" alt="Image of Maine Mendoza, happy client, TV personality" class="w-16 h-16 rounded-full object-cover border-4 border-pink-200">
                        <div>
            ...
            <div class="max-w-lg mx-auto px-4">
                ...
                <form action="handleBooking.php" method="POST" class="bg-white rounded-2xl shadow p-8 space-y-6" autocomplete="off">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" required class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-pink-400" tabindex="2">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select id="reason" name="reason" required class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400" tabindex="4">
                            <option value="">Select...</option>
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="3" required class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-pink-400" tabindex="5"></textarea>
                    </div>
                    <button type="submit" class="w-full py-3 bg-pink-600 text-white rounded-full font-semibold shadow hover:bg-pink-700 transition" tabindex="6">Book Now</button>
                </form>
            </div>
        </section>
